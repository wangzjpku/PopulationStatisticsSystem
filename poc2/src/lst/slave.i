            ...
            if (((sample[0] << 8) + sample[1] == 0x6868) 
                ...
                if (uart_read_oversize(port) >= 3 + sample[2] + 1) {
                    ...
                    *sample_size = (uint32_t) sample[2];
                    ...
                    return sample[*sample_size] == 0x00 ? 0 : -1;
                } else
                    break;
            } else
...
{
    if (port == UART_PORT1) {
        (*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*0)) + (0x4*8)))) = 1;
        return 0;
...
{
    if (port == UART_PORT1) {
        (*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*0)) + (0x4*8)))) = 0;
        return 0;
...
int slave_us_is_enabled(enum board_type type)
{
    if (type == SLAVE_LEFT_BOARD) {
        return (*((volatile uint32_t *) (((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x40*0)) + (0x4*11)))) == 1 ? 1 : 0;
