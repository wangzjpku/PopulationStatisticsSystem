...
{E_GPA,1},{E_GPA,2},{E_GPC,8},{E_GPC,11},   
{E_GPC,6},{E_GPC,7},{E_GPC,14},{E_GPC,15},   
...
void PWM_Configuration(int frequence , int pulseratio)
{
    ...
    DrvPWM_SetTimerClk(0x00, &sPt); 
     
    DrvPWM_SetTimerIO(0x00, 1); 
     
    DrvGPIO_InitFunction(E_FUNC_PWM01); 
     
    DrvPWM_Enable(0x00, 1); 
}
...
void TIMER_Configuration(void)
{
    ...
    DrvTIMER_Open(E_TMR0,(1 * 1000),E_PERIODIC_MODE);  
...
void ADC_Configuration(void)
{
    ...
    ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR.DMOF =0;
    delay_loop();                         
}
...
void PDMA_Configuration(void)
{
    ...
    sPDMA.sSrcCtrl.u32Addr      = (uint32_t)0;
    sPDMA.sDestCtrl.u32Addr     = ((( uint32_t)0x40000000) + 0x50000);   
...
void UART_DMA_Write(uint8_t *pu8TxBuf, uint8_t u32WriteBytes)
{
    ...
    if(pdma_write_protect != 1)  
    {  
        pdma_write_protect = 1;  
                ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->SAR = (uint32_t)pu8TxBuf;
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->u32BCR = u32WriteBytes;
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CSR.PDMACEN = 1;
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CSR.TRIG_EN = 1;         
    }
     return;    
}
